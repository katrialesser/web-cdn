...
class CdnConfig {
            ...
            return Promise.all([repoConfigPromise, contentShaPromise])
                .then(results => {
                    ...
                    return CdnConfig.createLibVersion(
                        realName, ref.ref, ref.tarballUrl, ref.commitSha, manifestVersion, repoConfig, contentSha, forceReload
                    );
                });
        }
     ...
     * @returns {Version}
     */
    static createLibVersion(name, ref, tarballUrl, sha, manifestVersion, repoConfig, contentSha, forceReload) {
        let entrypoints;
